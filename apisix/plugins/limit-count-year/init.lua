...
do
    local local_src = "apisix.plugins.limit-count-year.limit-count-year-local"
    limit_local_new = require(local_src).new

    local redis_src = "apisix.plugins.limit-count-year.limit-count-year-redis"
    limit_redis_new = require(redis_src).new

    local cluster_src = "apisix.plugins.limit-count-year.limit-count-year-redis-cluster"
