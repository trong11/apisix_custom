...
do
    local local_src = "apisix.plugins.limit-count-day.limit-count-day-local"
    limit_local_new = require(local_src).new

    local redis_src = "apisix.plugins.limit-count-day.limit-count-day-redis"
    limit_redis_new = require(redis_src).new

    local cluster_src = "apisix.plugins.limit-count-day.limit-count-day-redis-cluster"
