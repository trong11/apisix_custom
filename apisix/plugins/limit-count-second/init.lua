...
local plugin_name = "limit-count-second"
local limit_redis_cluster_new
local limit_redis_new
local limit_local_new
do
    local local_src = "apisix.plugins.limit-count-second.limit-count-second-local"
    limit_local_new = require(local_src).new

    local redis_src = "apisix.plugins.limit-count-second.limit-count-second-redis"
    limit_redis_new = require(redis_src).new

    local cluster_src = "apisix.plugins.limit-count-second.limit-count-second-redis-cluster"
